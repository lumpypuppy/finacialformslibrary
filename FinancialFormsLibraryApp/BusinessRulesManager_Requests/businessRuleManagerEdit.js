...
$('input[title="Customer Number Required Field"]').attr("disabled", true);
$('input[title="Customer Name"]').attr("disabled", true);
$('[title="Rule Type Required Field"]').attr("disabled", true);
$('input[title="Business Rule Number"]').attr("disabled", true);
